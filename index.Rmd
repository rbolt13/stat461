...
_ to find the median : order the data from smallest to largest and find the value in the middle 
...
_ to find the median : order the data set and find the value in the middle 
